...
constexpr std::uint8_t kFarmlandBlockId = 60;
...
inline constexpr remixapi_Float3D kGlassTransmittanceColor = {0.74f, 0.9f, 1.0f};
constexpr float kGlassMinTransmittanceColor = 0.01f;
constexpr float kGlassMaxTransmittanceColor = 1.0f;
constexpr float kGlassTransmittanceDistance = 1.5f;
constexpr float kGlassMinTransmittanceDistance = 0.01f;
constexpr float kGlassMaxTransmittanceDistance = 25.0f;
constexpr float kGlassRefractiveIndex = 1.333f;
constexpr float kGlassMinRefractiveIndex = 1.0f;
constexpr float kGlassMaxRefractiveIndex = 3.0f;
constexpr bool kGlassUseDiffuseLayer = true;
constexpr float kGlassDiffuseLayerScale = 1.0f;
constexpr float kGlassMinDiffuseLayerScale = 0.0f;
constexpr float kGlassMaxDiffuseLayerScale = 1.0f;
constexpr float kGlassThinWallThickness = 0.001f;
constexpr float kGlassDefaultThinWallThickness = 1.0f;
constexpr float kGlassMaxThinWallThickness = 5.0f;
