...
public final class ClientPatchTool {
    ...
    private static final String LIFECYCLE_BRIDGE_CLASS = "mcrtx/bridge/RemixLifecycleBridge";
    private static final String LIFECYCLE_HOOKS_CLASS = "MinecraftRemixLifecycleHooks";
    private static final String SCENE_HOOKS_CLASS = "MinecraftRemixSceneHooks";
    private static final String UI_HOOKS_CLASS = "MinecraftRemixUiHooks";
    private static final String ENTITY_HOOKS_CLASS = "MinecraftRemixEntityHooks";
    private static final String PARTICLE_HOOKS_CLASS = "MinecraftRemixParticleHooks";
    private static final String CHUNK_HOOKS_CLASS = "MinecraftRemixChunkHooks";
    ...
    private static void patchDkChunkDisplayListLookup(MethodNode method) {
        ...
        hook.add(new MethodInsnNode(
            ...
            hookOwner("shouldSuppressWorldRasterDisplayLists"),
    ...
    private static void patchMinecraftStartup(MethodNode method) {
        if (hasHelperCall(method, "onDisplayCreated", "(II)V")
                && hasMethodCall(method, LIFECYCLE_BRIDGE_CLASS, "rememberMinecraftInstance", "(Lnet/minecraft/client/Minecraft;)V")) {
            return;
        }
        ...
        for (AbstractInsnNode node = method.instructions.getFirst(); node != null; ) {
            ...
            if (isStaticCall(node, DISPLAY_CLASS, "isActive", "()Z")) {
                method.instructions.set(
                        ...
                        new MethodInsnNode(
                                Opcodes.INVOKESTATIC,
                                hookOwner("isWindowInteractionActive"),
        ...
        for (AbstractInsnNode node = method.instructions.getFirst(); node != null; node = node.getNext()) {
            if (node instanceof MethodInsnNode methodInsnNode
                ...
                method.instructions.set(
                        ...
                        new MethodInsnNode(
                                Opcodes.INVOKESTATIC,
                                hookOwner("shouldRenderBoundingBox"),
        ...
        while (node != null) {
            ...
            if (isStaticCall(node, GL11_CLASS, "glCallList", "(I)V")) {
                ...
                method.instructions.set(
                        ...
                        new MethodInsnNode(
                                Opcodes.INVOKESTATIC,
                                hookOwner("drawModelPartCallList"),
    ...
    private static void removeBlockOutlineRenderCalls(MethodNode method) {
        for (AbstractInsnNode node = method.instructions.getFirst(); node != null; ) {
            ...
            if (node instanceof MethodInsnNode methodInsnNode
                    && methodInsnNode.getOpcode() == Opcodes.INVOKESTATIC
                    && methodInsnNode.owner.equals(PARTICLE_HOOKS_CLASS)
    ...
    private static String hookOwner(String name) {
        switch (name) {
            ...
            case "onScreenshot":
            case "onRemixUiTick":
            case "isWindowInteractionActive":
            case "onFrameRenderStart":
                return LIFECYCLE_HOOKS_CLASS;
            case "onCamera":
            case "onFrameViewCaptured":
            case "shouldRenderBoundingBox":
            case "onWorldChanged":
            case "clearWorldScene":
            case "onCloudRender":
            case "onFogState":
            case "drawTessellator":
            case "onWorldRasterRenderStart":
            case "onWorldRasterRenderEnd":
            case "shouldSuppressWorldRasterDisplayLists":
                return SCENE_HOOKS_CLASS;
            case "onUiRenderBegin":
            case "onUiRenderEnd":
            case "onNameTagRenderBegin":
            case "onNameTagRenderEnd":
            case "captureFontStringAndMaybeSuppress":
                return UI_HOOKS_CLASS;
            case "onLivingEntityFrameBegin":
            case "onLivingEntityRenderStart":
            case "onLivingEntityRenderEnd":
            case "onPickupParticleEntityRenderStart":
            case "onPickupParticleEntityRenderEnd":
            case "onItemEntityRenderStart":
            case "onItemEntityRenderEnd":
            case "onEntityFireOverlayStart":
            case "onEntityFireOverlayEnd":
            case "onSignRenderStart":
            case "onSignRenderEnd":
            case "onMovingPistonRenderStart":
            case "onMovingPistonRenderEnd":
            case "onPaintingRender":
            case "tryReplacePaintingRender":
            case "drawModelPartCallList":
            case "tryReplaceSignModelRender":
            case "renderSignText":
            case "onSignTextRender":
            case "onFirstPersonRenderStart":
            case "onFirstPersonShadowPlayerRender":
            case "onFirstPersonRenderEnd":
            case "onFirstPersonItemRender":
            case "onPlayerEquippedItemRenderStart":
            case "onLivingEquippedItemRenderStart":
            case "onEntityTextureBind":
            case "onModelPartRender":
            case "onFirstPersonTessellatorDraw":
                return ENTITY_HOOKS_CLASS;
            case "onDestroyOverlayRender":
            case "onBlockOutlineRender":
            case "onParticleRender":
            case "captureParticleRender":
            case "onAnimatedParticleRender":
            case "captureAnimatedParticleRender":
    ...
    private static boolean hasHelperCall(MethodNode method, String name, String desc) {
        return hasMethodCall(method, hookOwner(name), name, desc);
    }
    ...
    private static InsnList onDisplayCreatedCall() {
        ...
        instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, hookOwner("onDisplayCreated"), "onDisplayCreated", "(II)V", false));
        return instructions;
    }
    ...
    private static InsnList onDisplayResetCall() {
        ...
        instructions.add(new VarInsnNode(Opcodes.ALOAD, 0));
        instructions.add(new FieldInsnNode(Opcodes.GETFIELD, MINECRAFT_CLASS, "e", "I"));
        instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, hookOwner("onDisplayReset"), "onDisplayReset", "(II)V", false));
        return instructions;
    }
    ...
    private static InsnList onResizeCall() {
        ...
        instructions.add(new VarInsnNode(Opcodes.ALOAD, 0));
        instructions.add(new FieldInsnNode(Opcodes.GETFIELD, MINECRAFT_CLASS, "e", "I"));
        instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, hookOwner("onResize"), "onResize", "(II)V", false));
        return instructions;
    }
    ...
    private static InsnList worldChangedCall() {
        ...
        instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, hookOwner("onWorldChanged"), "onWorldChanged", "(Lfd;)V", false));
        return instructions;
    }
    ...
    private static InsnList cameraUpdateCall() {
        ...
        instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, hookOwner("onCamera"), "onCamera", "(Lls;FIIFZ)V", false));
        return instructions;
    }
    ...
    private static InsnList uiRenderBeginCall() {
        ...
        instructions.add(new FieldInsnNode(Opcodes.GETFIELD, "px", "j", "Lnet/minecraft/client/Minecraft;"));
        instructions.add(new FieldInsnNode(Opcodes.GETFIELD, MINECRAFT_CLASS, "e", "I"));
        instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, hookOwner("onUiRenderBegin"), "onUiRenderBegin", "(II)V", false));
        return instructions;
    }
    ...
    private static InsnList staticHelperCall(String name, String descriptor) {
        InsnList instructions = new InsnList();
        instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, hookOwner(name), name, descriptor, false));
        return instructions;
    }
    ...
    private static InsnList weatherTextureBindCall(String texturePath) {
        ...
        instructions.add(new MethodInsnNode(
                Opcodes.INVOKESTATIC,
                hookOwner("onWeatherTextureBind"),
    ...
    private static InsnList livingEntityRenderStartCall() {
        ...
        instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, hookOwner("onLivingEntityRenderStart"), "onLivingEntityRenderStart", "(Lsn;F)V", false));
        return instructions;
    }
    ...
    private static InsnList signRenderStartCall() {
        InsnList instructions = new InsnList();
        instructions.add(new VarInsnNode(Opcodes.ALOAD, 1));
        instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, hookOwner("onSignRenderStart"), "onSignRenderStart", "(Lyk;)V", false));
        return instructions;
    }
    ...
    private static InsnList paintingRenderReplacementCall(LabelNode cleanupLabel) {
        InsnList instructions = new InsnList();
        instructions.add(new VarInsnNode(Opcodes.ALOAD, 1));
        instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, hookOwner("tryReplacePaintingRender"), "tryReplacePaintingRender", "(Lqv;)Z", false));
    ...
    private static InsnList movingPistonRenderStartCall() {
        InsnList instructions = new InsnList();
        instructions.add(new VarInsnNode(Opcodes.ALOAD, 1));
        instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, hookOwner("onMovingPistonRenderStart"), "onMovingPistonRenderStart", "(Luk;)V", false));
        return instructions;
    }
    ...
    private static InsnList signModelReplacementCall(LabelNode cleanupLabel) {
        ...
        instructions.add(new MethodInsnNode(
                Opcodes.INVOKESTATIC,
                hookOwner("tryReplaceSignModelRender"),
    ...
    private static InsnList firstPersonItemRenderCall() {
        ...
        instructions.add(new MethodInsnNode(
                Opcodes.INVOKESTATIC,
                hookOwner("onFirstPersonItemRender"),
    ...
    private static InsnList playerEquippedItemRenderCall() {
        ...
        instructions.add(new MethodInsnNode(
                Opcodes.INVOKESTATIC,
                hookOwner("onPlayerEquippedItemRenderStart"),
    ...
    private static InsnList livingEquippedItemRenderCall() {
        ...
        instructions.add(new MethodInsnNode(
                Opcodes.INVOKESTATIC,
                hookOwner("onLivingEquippedItemRenderStart"),
    ...
    private static InsnList firstPersonShadowPlayerRenderCall() {
        ...
        instructions.add(new MethodInsnNode(
                Opcodes.INVOKESTATIC,
                hookOwner("onFirstPersonShadowPlayerRender"),
    ...
    private static InsnList firstPersonTessellatorDrawCall() {
        ...
        instructions.add(new MethodInsnNode(
                Opcodes.INVOKESTATIC,
                hookOwner("onFirstPersonTessellatorDraw"),
    ...
    private static InsnList fontRenderReplacementCall(LabelNode continueLabel) {
        ...
        instructions.add(new MethodInsnNode(
                Opcodes.INVOKESTATIC,
                hookOwner("captureFontStringAndMaybeSuppress"),
    ...
    private static InsnList pickupParticleEntityRenderStartCall() {
        ...
        instructions.add(new MethodInsnNode(
                Opcodes.INVOKESTATIC,
                hookOwner("onPickupParticleEntityRenderStart"),
    ...
    private static InsnList itemEntityRenderStartCall() {
        ...
        instructions.add(new MethodInsnNode(
                Opcodes.INVOKESTATIC,
                hookOwner("onItemEntityRenderStart"),
    ...
    private static InsnList destroyOverlayRenderCall() {
        ...
        instructions.add(new MethodInsnNode(
                Opcodes.INVOKESTATIC,
                hookOwner("onDestroyOverlayRender"),
    ...
    private static InsnList blockOutlineRenderCall() {
        ...
        instructions.add(new MethodInsnNode(
                Opcodes.INVOKESTATIC,
                hookOwner("onBlockOutlineRender"),
